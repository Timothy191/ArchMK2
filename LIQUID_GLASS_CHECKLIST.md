...
*Primary goal: Establish the frosty glass look with standard CSS.*
...
*Primary goal: Break rigid box shapes and add liquid-like micro-interactions.*
...
- [x] Layer internal specular highlights with `box-shadow`:
  ```css
  box-shadow: inset 0 8px 16px rgba(255,255,255,0.4),
...
*Primary goal: Realistic background warping through the glass using WebGL.*
...
*Primary goal: Add the microscopic details that sell realism.*

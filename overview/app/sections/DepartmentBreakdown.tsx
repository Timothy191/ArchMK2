...
import { Building2, LayoutDashboard, FileText, Settings, History, BarChart3, Wrench } from "lucide-react"
...
export default function DepartmentBreakdown() {
  return (
    <div className="p-6">
      <div className="mb-6">
        <h2 className="text-2xl font-semibold text-[#fafafa]">Department Breakdown</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-6">
        {DEPARTMENTS.map((dept) => (
          <Card key={dept.id} className="bg-[#171717] border-[#363636] overflow-hidden">
            ...
            <CardHeader className="pb-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <CardTitle className="text-lg text-[#fafafa]">{dept.name}</CardTitle>
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 gap-2">
                  {dept.routes.map((route) => (
                    ...
                    >
                      <span className="text-[#898989]">{routeIcons[route.name]}</span>
                      <span className="text-[#b4b4b4] truncate" title={route.description}>
                        {route.name}
                      </span>
                    </div>
                  ))}
      ...
      <div className="mt-8 grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="glass-card p-4 rounded-xl">
          <div className="text-3xl font-bold text-[#3ecf8e]">{DEPARTMENTS.length}</div>

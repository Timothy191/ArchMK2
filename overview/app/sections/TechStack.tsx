      ...
      <div className="mt-8">
        ...
        <div className="glass-card p-6 rounded-xl">
          <div className="flex flex-wrap items-center justify-center gap-4">
            ...
            {/* Integration Layer */}
            <div className="flex flex-col items-center">
              <div className="text-xs text-[#898989] mb-2 uppercase tracking-wider">Integrations</div>
              <div className="flex gap-2">
          ...
          <div className="mt-6 pt-6 border-t border-[#363636]">
            <div className="text-xs text-[#898989] text-center">
              Data Flow: User → Middleware → Server Component → Supabase → PostgreSQL (RLS) → Response
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="mt-8">
        ...
        <div className="glass-card p-6 rounded-xl font-mono text-sm">
          <div className="text-[#b4b4b4]">
            ...
            <br />
            &nbsp;&nbsp;│&nbsp;&nbsp;&nbsp;└── <span className="text-[#3ecf8e]">portal/</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;# Next.js 14 application
            <br />
            &nbsp;&nbsp;│&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;├── <span className="text-[#898989]">app/</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;# App Router routes
            <br />
            &nbsp;&nbsp;│&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;├── <span className="text-[#898989]">features/</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;# Co-located components
            <br />
            &nbsp;&nbsp;│&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└── <span className="text-[#898989]">lib/</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;# App constants
            <br />
            &nbsp;&nbsp;├── <span className="text-[#60a5fa]">packages/</span>
            <br />
            &nbsp;&nbsp;│&nbsp;&nbsp;&nbsp;├── <span className="text-[#3ecf8e]">ui/</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;# Shared components
            <br />
            &nbsp;&nbsp;│&nbsp;&nbsp;&nbsp;├── <span className="text-[#3ecf8e]">supabase/</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;# SSR clients (server/client split)
            <br />
            &nbsp;&nbsp;│&nbsp;&nbsp;&nbsp;└── <span className="text-[#3ecf8e]">database/</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;# Migrations & types
            <br />
            &nbsp;&nbsp;└── <span className="text-[#60a5fa]">overview/</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;# This visualizer
          </div>
        </div>
      </div>
    </div>

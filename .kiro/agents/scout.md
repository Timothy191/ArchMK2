...
- Limit exploration to the minimum needed. Stop gathering context once confidence is >= 70.
- Prefer targeted grep/glob over broad file listing. Each unnecessary tool call consumes quota.
- If already confident from few searches, skip additional exploration and GO.

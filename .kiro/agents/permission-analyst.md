...
- Batch permission changes into a single recommendation. Each separate approval round costs an API call.
- Review the full tool call history before making recommendations to avoid repeated analysis.

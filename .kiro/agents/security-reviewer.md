...
- Scan files broadly with combined grep patterns rather than one pattern at a time.
- Prioritize high-risk patterns (auth, secrets, SQL, RLS) — skip low-risk checks if context is tight.

...
- Scan entire files at once rather than line-by-line. One Read per file is enough.
- Grep for all forbidden patterns in a single pass, not one pattern at a time.

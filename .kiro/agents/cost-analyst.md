...
- Reducing per-turn token consumption directly reduces rate limit frequency.
- Recommend steering file optimizations (shorter files, conditional inclusion) as cost-saving measures.
- Flag excessive context usage as a cost risk in audit reports.

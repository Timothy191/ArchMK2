    ...
    >
      ...
      <div className="flex items-center gap-1.5 shrink-0">
        <button
          ...
          aria-label="Close"
        >
          <span className="absolute inset-0 flex items-center justify-center text-[7px] text-red-900/70 font-bold leading-none opacity-0 group-hover/titlebar:opacity-100 transition-opacity">
            ×
          </span>
        </button>
        <button
          ...
          aria-label="Minimize"
        >
          <span className="absolute inset-0 flex items-center justify-center text-[7px] text-yellow-900/70 font-bold leading-none opacity-0 group-hover/titlebar:opacity-100 transition-opacity">
            −
          </span>
        </button>
        <button
          ...
          aria-label="Maximize"
        >
          <span className="absolute inset-0 flex items-center justify-center text-[7px] text-green-900/70 font-bold leading-none opacity-0 group-hover/titlebar:opacity-100 transition-opacity">
            +
          </span>
        </button>
      </div>

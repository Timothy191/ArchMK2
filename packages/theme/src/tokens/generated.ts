...
export const tokens = {
  color: {
    ...
    glass: {
      ...
      darkSurface: "var(--glass-dark-surface)",
      darkSurfaceHover: "var(--glass-dark-surface-hover)",
      darkBorder: "var(--glass-dark-border)",
      darkBorderTop: "var(--glass-dark-border-top)",
      darkShadow: "var(--glass-dark-shadow)",
    },
    vibrancy: {

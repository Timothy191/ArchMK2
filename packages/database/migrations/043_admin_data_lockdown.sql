...
-- ============================================
-- 12. excavator_dumper_assignments
-- ============================================
CREATE POLICY IF NOT EXISTS "excavator_dumper_assignments_update_admin"
  ON excavator_dumper_assignments FOR UPDATE
  TO authenticated
  USING (public.is_admin());
CREATE POLICY IF NOT EXISTS "excavator_dumper_assignments_delete_admin"

...
export function SafetyComplianceScore({
  data,
  departmentName,
}: SafetyComplianceScoreProps) {
...
Safety Checks: ${data.safetyChecksCompleted}/${data.totalChecks} completed
      ...
      setError(
        err instanceof Error
          ? err.message
          : "Failed to analyze safety compliance. AI service may be temporarily unavailable.",
      );
    } finally {
    ...
    <GlassCard className="p-5">
      ...
      {!result && !isAnalyzing && !error && (
        <div className="text-center py-6 text-[#898989]">
          <p className="text-sm">
            Click &quot;Analyze Safety&quot; to get AI-powered compliance
            assessment
          </p>
          <div className="mt-3 grid grid-cols-2 gap-2 text-xs">
            <div className="bg-[#171717] p-2 rounded">
              ...
              <p className="text-[#fafafa] font-medium">
                {data.safetyChecksCompleted}/{data.totalChecks}
              </p>
            </div>
            <div className="bg-[#171717] p-2 rounded">
      ...
      {result && (
        <div className="space-y-4">
          <div
            className={cn("p-4 rounded-xl border", getScoreColor(result.score))}
          >
            ...
            <div className="bg-red-500/5 border border-red-500/20 rounded-lg p-3">
              ...
              <ul className="space-y-1">
                {result.violations.map((v, i) => (
                  <li
                    key={i}
                    className="text-sm text-[#b4b4b4] flex items-start gap-2"
                  >
      ...
      <div className="mt-4 pt-4 border-t border-[#363636]">
        <p className="text-xs text-[#898989]">
          AI analyzes shift logs, incidents, and near-misses to assess safety
          compliance.
        </p>
      </div>
    </GlassCard>

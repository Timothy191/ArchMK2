    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <GlassCard>
          ...
          <p className="text-2xl font-bold text-white mt-1">{machines?.length ?? 0}</p>
        </GlassCard>
        <GlassCard>
        ...
        <GlassCard>
          ...
          <p className="text-2xl font-bold text-white/60 mt-1">{(machines?.length ?? 0) - activeCount}</p>
        </GlassCard>
      </div>
      ...
      <div className="space-y-3">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="flex items-center gap-3 mt-1">
                  <span className="text-white/40 text-xs">{machine.machine_type}</span>
                  {machine.serial_number && (
                    <span className="text-white/30 text-xs">SN: {machine.serial_number}</span>
                  )}
                </div>
              </div>
              <span
        ...
        {(!machines || machines.length === 0) && (
          <GlassCard>
            <p className="text-white/30 text-sm text-center py-8">No machines registered for this department.</p>
          </GlassCard>
        )}
      </div>
    </div>

          ...
          <table className="w-full text-left">
            <thead>
              <tr className="border-b border-white/10">
                ...
                <th className="px-6 py-3 text-xs font-semibold text-white/50 uppercase tracking-wider">Notes</th>
                <th className="px-6 py-3 text-xs font-semibold text-white/50 uppercase tracking-wider">Created</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-white/5">
              {logs?.map(log => (
                <tr key={log.id} className="hover:bg-white/[0.02] transition-colors">
                  ...
                  <td className="px-6 py-4 text-white/60 text-sm truncate max-w-xs">{log.notes || '—'}</td>
